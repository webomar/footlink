...
let stories = new Zuck("stories", {
  ...
  stories: [
    ...
    Zuck.buildTimelineItem(
      ...
      // Story photo src
      "static/assets/images/post/1by1/02.jpg",
    ...
    Zuck.buildTimelineItem(
      ...
      timestamp(),
      [
        ["user2-story1", "photo", 5, "static/assets/images/albums/03.jpg", "", '', false, false, timestamp()],
      ]
    ),
    ...
    Zuck.buildTimelineItem(
      "user-3",
      "static/assets/images/post/1by1/04.jpg",
      "Amanda Reed",
      "",
      timestamp(),
      [
